			...
			<div className={`${sContainer.container} ${s.container}`}>
				<Slide direction={'left'}>
					<div className={s.aboutDescription}>
						<div>
							I'm -
							<span className={s.fullNameColor}>
								<b> &nbsp;Pavel Khrysto</b>
							</span>
							, a Front-end Developer
						</div>
						<p className={s.textAbout}>{textAbout}</p>
					</div>
				</Slide>
				<Slide direction={'right'}>
					<div className={s.aboutInfo}>
						<p>
							<b>Name:</b> Pavel Khrtso
						</p>
						<div className={s.separator}></div>
						<p>
							<b>Email:</b> <a href={'miki2012miki@gmail.com'}>miki2012miki@gmail.com</a>
						</p>
						<div className={s.separator}></div>
						<p>
							<b>Age:</b> 27
